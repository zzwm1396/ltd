...
import com.lb.core.monitor.jvmmonitor.bean.JVMGC;
import com.lb.core.monitor.jvmmonitor.bean.JVMInfo;
import com.lb.core.monitor.jvmmonitor.bean.JVMMemory;
import com.lb.core.monitor.jvmmonitor.bean.JVMThread;
...
public class JVMMonitor {
    ...
    static {
        ...
        try {
            Class clazz = JVMMonitor.class.getClassLoader().loadClass(className);
